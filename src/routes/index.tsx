...
const FEATURED_PRODUCTS = [
  {
    ...
    name: "MergeKit",
    price: "$49",
    description: "CSV merging tool",
    rating: 4.8,
    reviewCount: 87,
    type: "Software Tool" as const,
    typeIcon: "monitor",
  },
  {
    slug: "clientflow-os",
  ...
  },
  {
    ...
    name: "Plain Talk",
    price: "$59",
    description: "Business writing course",
    rating: 4.7,
    reviewCount: 31,
...
const CATEGORIES = [
  { slug: "software-tools", name: "Software Tools", description: "Desktop apps, CLI tools, and plugins", icon: "monitor" },
  { slug: "templates", name: "Templates", description: "Notion, Google Sheets, and doc templates", icon: "file" },
  { slug: "ai-solutions", name: "AI Solutions", description: "Prompts, agents, and AI workflows", icon: "sparkle" },
  { slug: "business-systems", name: "Business Systems", description: "CRMs, project systems, and SOPs", icon: "cog" },
  { slug: "courses", name: "Courses", description: "Self-paced learning and workshops", icon: "cap" },
  { slug: "resources", name: "Resources", description: "Asset packs, icons, and toolkits", icon: "box" },
];

const REVIEWS = [
  {
    quote:
      "MergeKit replaced three different tools I was using. The visual deduplication alone saves me hours every week. I was skeptical at first, but the demo showed me exactly what I was getting.",
  ...
  {
    quote:
      "ClientFlow OS gave me back my weekends. Onboarding used to take 3 hours per client — now it's 20 minutes and the client does most of the work. The Notion setup is intuitive and the email templates are worth the price alone.",
    author: "Brand Designer",
    product: "ClientFlow OS",
    initials: "BD",
  },
  {
    quote:
      "I've tried grammar checkers, YouTube videos, and even a live course. Plain Talk is the first thing that actually made my writing clearer. My manager noticed the difference within two weeks. Worth every penny.",
...
function VerifiedBadgeIcon() {
  return (
    ...
    >
      <path
        d="M7 1l1.57 3.23L12 4.73l-1.1 3.38L12 11.5l-3.43-.5L7 14l-1.57-3L2 11.5l1.1-3.39L2 4.73l3.43.5L7 1z"
        fill="#16B3A7"
      />
      <path
        d="M5.5 7l1.5 1.5 2-2"
        stroke="white"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function CogIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M12 1v3m0 16v3M1 12h3m16 0h3M4.93 4.93l2.12 2.12m9.9 9.9l2.12 2.12M4.93 19.07l2.12-2.12m9.9-9.9l2.12-2.12"
        stroke="#16B3A7"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
const typeGradients: Record<string, string> = {
  "Software Tool": "from-brand-50 via-neutral-50 to-neutral-100",
  Template: "from-neutral-50 via-brand-50/40 to-neutral-100",
  "AI Solution": "from-accent-50 via-neutral-50 to-brand-50/60",
  Course: "from-neutral-50 via-accent-50/40 to-neutral-100",
  "Business System": "from-brand-50/60 via-neutral-50 to-accent-50/40",
  Resource: "from-neutral-50 via-neutral-100 to-brand-50/40",
};
      ...
      <div className="mx-auto max-w-6xl px-6 pb-20 pt-20 sm:pt-28 sm:pb-24">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="text-4xl font-bold tracking-tight text-neutral-800 sm:text-5xl lg:text-6xl">
            Digital products you can see before you buy.
          </h1>
          <p className="mt-6 text-lg text-neutral-500 sm:text-xl">
            Browse tools, templates, and courses from independent creators.
            Every product has a demo, a clear price, and real reviews.
          </p>
...
function ProductTypeBadge({ type }: { type: string }) {
  return (
    <span className="inline-block rounded-full border border-neutral-200 bg-transparent px-2.5 py-0.5 text-xs font-medium text-neutral-600">
      {type}
    </span>
  );
}
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-neutral-500">
            Hand-picked tools our buyers love right now.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURED_PRODUCTS.map((product) => {
            ...
            const gradient = typeGradients[product.type] ?? "from-neutral-50 to-neutral-100";
            return (
              <Link
                key={product.slug}
              ...
              >
                {/* Thumbnail */}
                <div
                  className={`relative flex aspect-[16/10] items-center justify-center rounded-t-xl bg-gradient-to-br ${gradient}`}
                >
  ...
  const steps = [
    {
      ...
      description:
        "Search or explore categories to find software tools, templates, and courses.",
    },
    {
      number: 2,
      title: "See before you buy",
      description:
        "Watch a real demo, check features, and read reviews from verified buyers.",
    },
    {
      number: 3,
      title: "Instant access",
      description:
        "Check out with Stripe and download immediately. Your account is created automatically.",
    },
  ];
    ...
    <section className="bg-neutral-50">
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold text-neutral-800">
            Three steps to a better tool
          </h2>
          <p className="mt-3 text-lg text-neutral-500">
            No mystery boxes. No surprise subscriptions. Just transparent buying.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-8 sm:grid-cols-3">
          {steps.map((step) => (
            <div
              key={step.number}
              className="rounded-xl border border-neutral-200 bg-white p-6 transition-shadow duration-200 hover:shadow-sm"
            >
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-brand-50 text-sm font-bold text-brand-600">
                {step.number}
              </div>
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-neutral-500">
            Find exactly what you need — every product is organized by type.
          </p>
        </div>
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h3 className="text-base font-semibold text-neutral-800 transition-colors group-hover:text-brand-600">
                    {cat.name}
                  </h3>
    ...
    <section className="bg-neutral-50">
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg text-neutral-500">
            Honest feedback from people who purchased through PrismBay.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-neutral-500">
            Browse the marketplace, watch some demos, and see what fits.
          </p>
          <div className="mt-8">
            <Link
              to="/products"
    ...
    <footer className="bg-neutral-900">
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-12">
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
          {/* Categories */}
          <div>
            <h4 className="mb-4 text-sm font-semibold text-neutral-100">
              Categories
            </h4>
